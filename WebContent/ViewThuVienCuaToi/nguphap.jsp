    ...
    <div id="q">
         <form  method="get" action="/FileRead">
		  <table border="0">
			...
			<legend style="color:blue">NGỮ PHÁP TIẾNG ANH</legend>
<%
    String ma_nd=(String)request.getSession().getAttribute("_user");
  	String query = "select doc_id, filename,tenfile from document where madulieu=11112 and MaNguoiDung='"+ma_nd+"'";
	  ...
	  while(rs.next())
	  {
	    out.println("<tr>"
	        ...
	        + "<td>"
	        +   "<a href='ViewThuVienCuaToi/deletenguphap.jsp?doc_id="+rs.getInt(1) +"'> Delete </a>"
	        + "</td>"
	        +"<td>"
